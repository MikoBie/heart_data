"""Plot the results from Aarhus: demo site visits questions"""
...
aarhus["2 How do you usually get to the demo site?"] = (
    aarhus["2 How do you usually get to the demo site?"]
    .astype("category")
...
aarhus["3 How long does it take to get to the demo site?"] = (
    aarhus["3 How long does it take to get to the demo site?"]
    .astype("category")
    .cat.reorder_categories(
        [
...
aarhus["4 When do you usually visit the demo site?"] = (
    aarhus["4 When do you usually visit the demo site?"]
    .astype("category")
    .cat.reorder_categories(
...
aarhus["5.1 How often do you usually visit the demo site? -- Winter"] = (
    aarhus["5.1 How often do you usually visit the demo site? -- Winter"]
    .astype("category")
    .cat.reorder_categories(
        [
...
aarhus["5.2 How often do you usually visit the demo site? -- Spring"] = (
    aarhus["5.2 How often do you usually visit the demo site? -- Spring"]
    .astype("category")
    .cat.reorder_categories(
        [
...
aarhus["5.3 How often do you usually visit the demo site? -- Summer"] = (
    aarhus["5.3 How often do you usually visit the demo site? -- Summer"]
    .astype("category")
    .cat.reorder_categories(
        [
...
aarhus["5.4 How often do you usually visit the demo site? -- Autumn"] = (
    aarhus["5.4 How often do you usually visit the demo site? -- Autumn"]
    .astype("category")
    .cat.reorder_categories(
        [
...
aarhus["6.1 What time during the day do you usually visit the demo site? -- Winter"] = (
    aarhus["6.1 What time during the day do you usually visit the demo site? -- Winter"]
    .astype("category")
    .cat.reorder_categories(
        ["Midday", "Afternoon", "I don't visit"],
        ordered=True,
    )
)

aarhus["6.2 What time during the day do you usually visit the demo site? -- Spring"] = (
    aarhus["6.2 What time during the day do you usually visit the demo site? -- Spring"]
    .astype("category")
    .cat.reorder_categories(
        ["Morning", "Midday", "Afternoon", "I don't visit"],
        ordered=True,
    )
)

aarhus["6.3 What time during the day do you usually visit the demo site? -- Summer"] = (
    aarhus["6.3 What time during the day do you usually visit the demo site? -- Summer"]
    .astype("category")
    .cat.reorder_categories(
        ["Midday", "Afternoon", "I don't visit"],
...
aarhus["6.4 What time during the day do you usually visit the demo site? -- Autumn"] = (
    aarhus["6.4 What time during the day do you usually visit the demo site? -- Autumn"]
    .astype("category")
    .cat.reorder_categories(
        ["Midday", "Afternoon", "I don't visit"],
...
aarhus["7 What do you usally do during the visits to the demo site?"] = (
    aarhus["7 What do you usally do during the visits to the demo site?"]
    .astype("category")
    .cat.reorder_categories(
        ["Sit", "Walk", "Use open gym", "Other"],
        ordered=True,
    )
)

aarhus["31 Do you have access in your neighbourghood to the following services?"] = (
    aarhus[
